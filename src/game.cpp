...
Game::Game()
    : m_window(Window("minecraft-opengl", 1280, 720)),
    m_camera(Camera(glm::vec3(0.0f, 0.0f, 3.0f), m_window.getAspectRatio())),
    m_quadShader(Shader("quad_vertex.glsl", "quad_fragment.glsl")) {
...
void Game::update() {
    ...
    const AtlasRegion* region = m_atlasManager.getRegion("test0");
